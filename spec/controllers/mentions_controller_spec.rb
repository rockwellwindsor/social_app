...
RSpec.describe MentionsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested mention as @mention" do
      mention = Mention.create! valid_attributes
      get :show, params: {id: mention.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested mention as @mention" do
      mention = Mention.create! valid_attributes
      get :edit, params: {id: mention.to_param}, session: valid_session
      expect(assigns(:mention)).to eq(mention)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Mention" do
        expect {
          post :create, params: {mention: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved mention as @mention" do
        post :create, params: {mention: invalid_attributes}, session: valid_session
        expect(assigns(:mention)).to be_a_new(Mention)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested mention" do
        mention = Mention.create! valid_attributes
        put :update, params: {id: mention.to_param, mention: new_attributes}, session: valid_session
        mention.reload
      ...
      it "assigns the requested mention as @mention" do
        mention = Mention.create! valid_attributes
        put :update, params: {id: mention.to_param, mention: valid_attributes}, session: valid_session
        expect(assigns(:mention)).to eq(mention)
      end
    ...
    context "with invalid params" do
      it "assigns the mention as @mention" do
        mention = Mention.create! valid_attributes
        put :update, params: {id: mention.to_param, mention: invalid_attributes}, session: valid_session
        expect(assigns(:mention)).to eq(mention)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested mention" do
      mention = Mention.create! valid_attributes
      expect {
        delete :destroy, params: {id: mention.to_param}, session: valid_session
      }.to change(Mention, :count).by(-1)
    end
