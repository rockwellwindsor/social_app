...
RSpec.describe ParticipantsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested participant as @participant" do
      participant = Participant.create! valid_attributes
      get :show, params: {id: participant.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested participant as @participant" do
      participant = Participant.create! valid_attributes
      get :edit, params: {id: participant.to_param}, session: valid_session
      expect(assigns(:participant)).to eq(participant)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Participant" do
        expect {
          post :create, params: {participant: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved participant as @participant" do
        post :create, params: {participant: invalid_attributes}, session: valid_session
        expect(assigns(:participant)).to be_a_new(Participant)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested participant" do
        participant = Participant.create! valid_attributes
        put :update, params: {id: participant.to_param, participant: new_attributes}, session: valid_session
        participant.reload
      ...
      it "assigns the requested participant as @participant" do
        participant = Participant.create! valid_attributes
        put :update, params: {id: participant.to_param, participant: valid_attributes}, session: valid_session
        expect(assigns(:participant)).to eq(participant)
      end
    ...
    context "with invalid params" do
      it "assigns the participant as @participant" do
        participant = Participant.create! valid_attributes
        put :update, params: {id: participant.to_param, participant: invalid_attributes}, session: valid_session
        expect(assigns(:participant)).to eq(participant)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested participant" do
      participant = Participant.create! valid_attributes
      expect {
        delete :destroy, params: {id: participant.to_param}, session: valid_session
      }.to change(Participant, :count).by(-1)
    end
